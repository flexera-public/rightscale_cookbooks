...
== DESCRIPTION:
Replace this text with a high-level overview of what this cookbook configures or manages.
Don't go into too much detail here, save that for the 'details' section below.
...
* What user will have to add to template to make recipes from this cookbook work correctly
...
== SETUP/USAGE:
Describe minimum required set of actions required for correct work of recipes from this cookbook.

==== Example:


Place <tt>app_tomcat::default</tt> recipe into your runlist to setup the application server.
...
Set ‘jdbc/ConnDB’ as your datasource name to set up database connection with the application server.
...
Replace this text with a common information about cookbook elements and anything else that users need to know in order to properly use this cookbook.
...
Please create description only for "internal" attributes here e.g those which have no inputs. 'set' directive in attributes/default.rb cookbook file.
...
Give complete description of definition functionality and provide examples of how it's used in recipes.
...
Give complete description of library purpose and  functionality. Provide examples of how it's used in recipes.
...
* Give common information about existing LWRPs in your cookbook, and point user to common info about RightScale LWRPs.
