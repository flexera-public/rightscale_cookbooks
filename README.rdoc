...
cookbook as the resource or, in the case of the Default Recipe pattern, in the
each of the implementation cookbooks. In the RightScale cookbooks, definitions
are prefixed with the cookbook name; they are located in the
<tt>definitions/</tt> directory in the cookbook (for example
