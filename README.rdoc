...
As a good starting point, the <b>COOKBOOK LIST</b> section below will give you a summary of what each cookbook does.  From there, each cookbook has it's own README file that goes into depth about what it does and how to use it -- this is the information you need if you want to create a runlist or ServerTemplate by mixing and matching recipes.  
...
TODO: Paraphase this pattern from the support site, then reference site
