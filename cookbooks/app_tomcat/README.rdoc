...
== DETAILS:
=== General
<tt>app_tomcat</tt> cookbook will help you to install and setup tomcat application server, which can be able to connect, to MySQL or Postgres database server.
...
<tt>app_tomcat</tt> Light Weight provider is defined in providers/default.rb file, it contains source for
...
* <tt>:setup_vhost</tt> - Will setup apache vhost file, with tomcat module directives included Install and setup tomcat package dependencies. Tomcat configs setup.
