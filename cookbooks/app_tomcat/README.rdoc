...
== DETAILS:
=== General
The <tt>app_tomcat</tt> cookbook will install and setup tomcat application
server, which can connect to MySQL or Postgres database servers.
...
* <tt>node[:tomcat][:db_adapter]</tt> -  - Type of database adapter. MySQL orPostgres.
