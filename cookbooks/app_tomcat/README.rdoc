...
The <tt>app_tomcat</tt> cookbook will install and setup Apache web server with mod_jk module
and Tomcat application server, with support of MySQL or Postgres database servers.
Cookbook will create separate vhost config for Apache web server, which will allow
