...
For more info see: http://support.rightscale.com/18-Release_Notes/ServerTemplates_and_RightImages/current (Section ‘Tomcat App Server’ under ServerTemplates)
