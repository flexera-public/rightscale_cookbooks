...
attribute "db_mysql/ca_certificate",
  ...
  :description => "The name of your CA SSL Certificate. Example: cred:CA_CERT",
  :required => "optional",
  :default =>  "",
  :recipes => [
    "db_mysql::setup_server_5_1",
...
attribute "db_mysql/master_certificate",
  ...
  :description => "The name of your Master SSL Certificate. Example: cred:MASTER_CERT",
  :required => "optional",
  :default =>  "",
  :recipes => [
    "db_mysql::setup_server_5_1",
...
attribute "db_mysql/master_key",
  ...
  :description => "The name of your Master SSL Key. Example: cred:MASTER_KEY",
  :required => "optional",
  :default =>  "",
  :recipes => [
    "db_mysql::setup_server_5_1",
...
attribute "db_mysql/slave_certificate",
  ...
  :description => "The name of your Slave SSL Certificate. Example: cred:SLAVE_CERT",
  :required => "optional",
  :default =>  "",
  :recipes => [
    "db_mysql::setup_server_5_1",
...
attribute "db_mysql/slave_key",
  ...
  :description => "The name of your Slave SSL Key. Example: cred:SLAVE_KEY",
  :required => "optional",
  :default =>  "",
  :recipes => [
    "db_mysql::setup_server_5_1",
