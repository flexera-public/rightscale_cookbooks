...
override repository please see: {Override Chef Cookbooks}[http://support.rightscale.com/12-Guides/Chef_Cookbooks_Developer_Guide/04-Developer/ServerTemplate_Development/08-Common_Development_Tasks/Override_Chef_Cookbooks].
...
<tt>db_mysql_set_read_only</tt>. This flag is set to 'false' by default and
changed to 'true' while initializing a slave server, and set back to 'false'
when the slave is promoted to a master server.
