...
* Place the <tt>db_mysql::setup_server_<version></tt> recipe into your runlist to
  load the MySQL provider, tuning parameters, as well as other MySQL-specific attributes
...
* Place the <tt>db::install_server</tt> recipe after setup_server_<version> recipe in
  ...
  This will set up and install MySQL 5.5 client and server.
