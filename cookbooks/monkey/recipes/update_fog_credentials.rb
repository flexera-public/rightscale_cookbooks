...
template "/root/.fog" do
  ...
  variables(
    ...
    :aws_publish_key => node[:monkey][:fog][:aws_publish_key],
    :aws_publish_secret_key => node[:monkey][:fog][:aws_publish_secret_key],
    ...
    :raxprivatev3_access_key_id => node[:monkey][:fog][:raxprivatev3_access_key_id],
    :raxprivatev3_secret_access_key => node[:monkey][:fog][:raxprivatev3_secret_access_key],
    :raxprivatev3_auth_url => node[:monkey][:fog][:raxprivatev3_auth_url],
