...
template "/root/.fog" do
  ...
  variables(
    ...
    :raxprivate_access_key_id: => node[:monkey][:fog][:raxprivate_access_key_id],
    :raxprivate_secret_access_key: => node[:monkey][:fog][:raxprivate_secret_access_key],
    :raxprivate_auth_url: => node[:monkey][:fog][:raxprivate_auth_url],
