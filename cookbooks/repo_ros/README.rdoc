...
Cookbook only supports the retrieval of code from Amazon S3 and Rackspace Cloud Files.
...
The <tt>repo_ros</tt> provider allows the retrieval of source code from Amazon S3 and Rackspace Cloud Files ROS remote repositories.
