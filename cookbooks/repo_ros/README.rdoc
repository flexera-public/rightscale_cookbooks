...
The <tt>repo/default/endpoint</tt> input allows to override the default
endpoint.
...
The <tt>repo_ros</tt> provider allows the retrieval of source code from Amazon
S3, Rackspace Cloud Files, Swift and SoftLayer Object Storage ROS remote
repositories.
