...
<tt>repo_ros</tt> provider allows to get source code from Amazon S3 and Rackspace Cloud files Remote Object Store remote repositories.
...
* Standard Opscode chef capistrano implementation doesn't support ROS,
* Downloaded ROS repository will be converted to git repository
* Then capistrano deployment will be applied using <tt>capistranize</tt> definition
* Git attributes will be removed after successful apply.
