...
Cookbook only supports the retrieval of code from Amazon S3, Rackspace Cloud Files, and Swift.
...
The <tt>repo_ros</tt> provider allows the retrieval of source code from Amazon S3, Rackspace Cloud Files, and Swift ROS remote repositories.
