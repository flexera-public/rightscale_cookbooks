...
Built upon the opscode iptables cookbook, this coobook provides a LWRP for
managing access to mutliple servers in a deployment using machine tags.
...
* Use the default recipe in conjunction with the 'Firewall' input to enable or
  disable iptables.
