...
1. Prior to launching a sever set the advanced input
   <tt>rightscale/security_update</tt> to <tt>Enabled</tt>
...
1. On a running a sever set the advanced input <tt>rightscale/security_update</tt>
   to <tt>Enabled</tt>
