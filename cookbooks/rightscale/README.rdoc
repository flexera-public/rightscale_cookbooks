...
<tt>rightscale/security_update</tt> input is set to "enable", otherwise 
...
1. Prior to launching a server set the advanced input
   <tt>rightscale/security_update</tt> to <tt>enable</tt>
...
1. On a running a server set the advanced input <tt>rightscale/security_update</tt>
   to <tt>enable</tt>
