...
Place the <tt>lamp::default</tt> recipe into your boot recipes after
<tt>db_mysql::setup_server_<version></tt> and <tt>db::install_server</tt> and
<tt>app_php::setup_server_5_3</tt> and <tt>app::install_server</tt> recipes.
