...
attribute "sys_dns/choice",
  ...
  :description => "The name of your DNS provider. Select the DNS provider " +
...
attribute "sys_dns/id",
  ...
  :description => "The unique identifier that is associated " +
    "with the DNS A record of the server. The unique identifier " +
    "is assigned by the DNS provider when you create a dynamic DNS A record. " +
    "This ID is used to update the associated A record with the private " +
    "IP address of the server when this recipe is run. " +
    "If you are using DNS Made Easy as your DNS provider, " +
    "a 7-digit number is used (e.g., 4403234). " +
...
attribute "sys_dns/user",
  ...
  :description => "The username that is used to access and modify " +
    "the DNS A records. For DNS Made Easy and DynDNS, enter your user name " +
...
attribute "sys_dns/password",
  ...
  :description => "The password that is used to access and modify " +
    "the DNS A Records. For DNS Made Easy and DynDNS, enter your password " +
