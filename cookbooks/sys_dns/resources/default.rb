...
# Sets up DNS provider
actions :set

# Unique identifier associated with the DNS A record of the server
attribute :id, :kind_of => String

# User name to access and modify DNS A records
attribute :user, :kind_of => String

# Password to access and modify DNS A records
...
# Choice of the supported DNS providers: "DNSMadeEasy", "DynDNS", "Route53", or "CloudDNS"
