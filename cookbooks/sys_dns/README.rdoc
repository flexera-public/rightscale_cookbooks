...
For additional information: {Deployment Prerequisites}[http://support.rightscale.com/ServerTemplates/v12.11_LTS/Supplemental/Deployment_Prerequisites_(Linux)]
...
For more information, please see {Lightweight Resources and Providers}[http://support.rightscale.com/12-Guides/Chef_Cookbooks_Developer_Guide/04-Developer/06-Development_Resources/Lightweight_Resources_and_Providers_(LWRP)].
