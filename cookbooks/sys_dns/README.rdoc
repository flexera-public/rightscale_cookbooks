...
Cookbook currently supports CloudDNS, DNSMadeEasy, DynDns, and Amazon Route53 DNS service providers.
...
* <tt>node[sys_dns][region]</tt> - CloudDNS specific: region where the A records should be modified.
...
* <tt>region::</tt> CloudDNS specific: region where the A records should be modified.
