...
attribute "memcached/memtotal_percent",
  ...
  :description => "Set the amount of memory allocated to memcached " +
...
attribute "memcached/threads",
  ...
  :description => "The number of threads to use when processing " +
    "incoming requests. Example: 4",
  :required => "recommended",
  :default => "1",
  :recipes => ["memcached::install_server"]
...
attribute "memcached/log_level",
  ...
  :description => "Without the verbose options, memcached normally produces " +
    "no output during normal operating. Example: off",
  :required => "optional",
