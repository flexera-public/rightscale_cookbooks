...
* When using a RightScale ServerTemplate, use <tt>memcached::default</tt> recipe to automatically add the server tags.
* Place <tt>memcached::install_server</tt> recipe into your runlist to setup the memcached server.
