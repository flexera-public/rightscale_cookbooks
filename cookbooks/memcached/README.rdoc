...
* <tt>node[:memcached][:tcp_port]</tt> - The TCP port to used for connections. Default : 11211
* <tt>node[:memcached][:udp_port]</tt> - The UDP port to used for connections. Default : 11211
