...
* Requires repo LightWeight resource cookbook https://github.com/rightscale/rightscale_cookbooks/tree/sprint12_4_a38540_cookbook_doc_structure/cookbooks/repo
or your own implementation of "repo" provider. See "repo" cookbook readme for details.
...
* To access to private git repositories repo/ssh_key input must contain string with private ssh key or "key" variable from RightScale dashboard.
...
Gide at:  http://support.rightscale.com/12-Guides/Chef_Cookbooks_Developer_Guide/08-Chef_Development/Lightweight_Resources_and_Providers_(LWRP)
...
RightScale::Repo::Ssh_key(ssh_key)

Create environment variable, which will contain user defined shh key required to access to private git source code repositories.
