...
* Must be use with a 'logging' provide in the cookbook path
...
1. Local logging only.  Set the input logging/remote_server to ignore.  The default
   configuration installed will be used.

2. Remote logging.  Set the input logging/remote_server to the FQDN or IP of your
...
By using a override cookbook the default configuration can be customized by replacing
the providers default configuration file template.
