...
attribute "db/backup/restore_version_check",
  ...
  :description => "A variable for allowing the restoration of a database from a backup that was performed on a different version of the DB software. Make sure you fully understand the implications of cross-version restoration.  Set to 'False' to skip version checking. Example: False",
  :required => "optional",
  :choice => ["true", "false"],
  :default => "true",
  :recipes => [
