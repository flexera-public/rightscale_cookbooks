...
log "  Setting up Master secondary backup cron job to run at hour: #{master_hour} and minute #{master_minute}" do
...
log "  Setting up Slave secondary backup cron job to run at hour: #{slave_hour} and minute #{slave_minute}" do
