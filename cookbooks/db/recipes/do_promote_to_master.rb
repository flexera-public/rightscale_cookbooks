...
# See cookbooks/db/definitions/db_state_assert.rb for
...
# See cookbooks/db/recipes/setup_replication_privileges.rb for
# "db::setup_replication_privileges" recipe.
...
# Demote old master
# See http://support.rightscale.com/12-Guides/Chef_Cookbooks_Developer_Guide/Chef_Resources#RemoteRecipe
# for "remote_recipe" resource."remote_recipe" resource.
remote_recipe "demote master" do
  # See cookbooks/db/recipes/handle_demote_master.rb for
  # "db::handle_demote_master" recipe.
...
# See cookbooks/db/definitions/db_register_master.rb for
...
# Perform a backup
# See cookbooks/db/definitions/db_request_backup.rb for
