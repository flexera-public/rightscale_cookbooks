...
For more info please see: {Load Balancer Setups}[http://support.rightscale.com/ServerTemplates/v12.11_LTS/ST/Load_Balancer_with_HAProxy_Server_-_Overview/Load_Balancer_with_HAProxy_(v12.11_LTS)_-_Tutorial].
...
see: {Lightweight Resources and Providers (LWRP)}[http://support.rightscale.com/12-Guides/Chef_Cookbooks_Developer_Guide/04-Developer/06-Development_Resources/Lightweight_Resources_and_Providers_(LWRP)].
