...
* Configures rsyslog to log to a remote server or use default local file logging.
...
The <tt>logging_rsyslog</tt> cookbook does the minimal configuration for a remote logging setup.
