...
recipe "sys::do_reconverge_list_enable", "Enables the periodic execution " +
  "(every 15 minutes) of recipes specified in the 'Reconverge List' input."
...
attribute "sys/swap_size",
  ...
  :description => "Creates and activates a swap file based on the selected " +
    "size (in GB). Note: The swap added by this file will be in addition to " +
...
attribute "sys/swap_file",
  ...
  :description => "The location of the swap file. " +
    "Example: /mnt/ephemeral/swapfile",
  :type => "string",
