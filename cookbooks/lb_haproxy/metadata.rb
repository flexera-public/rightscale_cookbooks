...
recipe "lb_haproxy::setup_server", "This loads the required 'lb' " +
  "resource using the HAProxy provider."

attribute "lb_haproxy/algorithm",
  :display_name => "Load Balancing Algorithm",
  :description => "The algorithm that the load balancer will use " +
    "to direct traffic. Example: roundrobin",
  :required => "optional",
  :default => "roundrobin",
