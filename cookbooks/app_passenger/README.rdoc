...
<tt>app_passenger</tt> cookbook will install and setup Apache + Phusion passenger application server configured to connect with a MySQL or Postgres database server.
...
<tt>app_passenger</tt> Light Weight provider is defined in providers/default.rb file, it contains source for
