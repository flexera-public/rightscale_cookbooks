...
* Tested on CentOS 5.8 and CentOS 6.2 RightImage
* Tested on Ubuntu 10.04 and Ubuntu 12.04 RightImage
...
For more info see: http://support.rightscale.com/18-Release_Notes/ServerTemplates_and_RightImages/current (Section 'Apache-Rails-Passenger App Server' under ServerTemplates)
...
* <tt>node[:app_passenger][:apache_psr_install_module]</tt> - Path to Ruby passenger executable.
