...
* Set desired action for your 'repo' resource
  ...
  :capistrano_pull - performs pulling and backup of yuor code.
...
Parameters:
All parmetres in this definition are linked to corresponding attributes. However if you use this definition for your own purposes you can redifine them. See example below.
...
For now we have repo_ros, repo_git and repo_svn cookboks. Each of them contain implementation of corresponding repo_* LightWeight Provider
