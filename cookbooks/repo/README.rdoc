...
* <tt>node[:repo][:default][:provider]</tt> - A repository provider: repo_git for Git, repo_svn for SVN or repo_ros for Remote Object Store. Default is:"repo_git"
...
=== LWRPs:
==== Resources
This cookbook provides abstract <tt>repo</tt> resource. Which will be used to call existing or user defined Light Weight repo_* providers.

For now we have repo_ros, repo_git and repo_svn cookbooks. Each of them contain implementation of corresponding repo_* Light Weight Provider
