...
attribute "repo/default/provider",
  ...
  :description => "Specify where the application code should be " +
    "checked out from. Example: repo_git",
...
attribute "repo/default/repository",
  ...
  :description => "The URL that points to the location of the repository " +
...
attribute "repo/default/account",
  ...
  :description => "The account name (i.e. username, ID) " +
    "that is required to access files in the specified location. " +
    "This input is optional and may not be required. " +
...
attribute "repo/default/credential",
  ...
  :description => "A valid credential " +
    "(i.e. password, SSH key, account secret) to access files " +
    "in the specified location. This input is always required for Git " +
    "and Rsync but may be optional for other providers. " +
...
attribute "repo/default/ssh_host_key",
  ...
  :description => "A valid SSH key which will be appended to " +
    "/root/.ssh/known_hosts file. This input will allow to verify " +
    "the destination host, by comparing its IP,FQDN, SSH-RSA with the record " +
    "in /root/.ssh/known_hosts file. Use this input if you want to improve " +
    "security and for MiTM attacks prevention " +
    "Example: cred:SSH_KNOWN_HOST_KEY.",
  :required => "optional",
  :recipes => ["repo::default"]

attribute "repo/default/perform_action",
  :display_name => "Action",
  :description => "Specify how the application code will be pulled from " +
...
attribute "repo/default/storage_account_provider",
  ...
  :description => "The Remote Object Storage (ROS) service where the tarball " +
...
attribute "repo/default/prefix",
  ...
  :description => "The prefix that will be used to locate the correct " +
    "tarball of the application. For example, if you're using 'myapp.tgz' " +
