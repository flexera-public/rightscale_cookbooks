...
attribute "app_php/modules_list",
  ...
  :description => "An optional list of php module packages to install. " +
    "Accepts an array of package names. When using CentOS, package names " +
    "are prefixed with php53u instead of php. " +
    "To see a list of available php modules on CentOS, " +
    "run 'yum search php53u' on the server. " +
