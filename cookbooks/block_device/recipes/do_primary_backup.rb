...
# Here, we create a snapshot of the block device mentioned in
# node[:block_device][:devices_to_use] and back it up to a specific lineage
# in the cloud specified in primary_cloud attribute. Actions "snapshot" and
# "primary_backup" are defined in cookbooks/block_device/providers/default.rb.
# See cookbooks/block_device/libraries/block_device.rb for the definition of
# "do_for_block_devices" and "get_device_or_default" method.
#
